...
(thrift:def-package :cassandra-8-3-0)

(cl:in-package :cassandra-8-3-0)
...
(thrift:def-struct "indexexpression"
  (("column_name" nil :type string :id 1)
   ("op" nil :type (enum "IndexOperator") :id 2)
   ("value" nil :type string :id 3)))

(thrift:def-struct "indexclause"
  (("expressions" nil :type (thrift:list (struct "indexexpression")) :id 1)
   ("count" 100 :type i32 :id 2)
   ("start_key" nil :type string :id 3 :optional t)))
...
(thrift:def-struct "rowpredicate"
  (("keys" nil :type (thrift:list string) :id 1 :optional t)
   ("key_range" nil :type (struct "keyrange") :id 2 :optional t)
   ("index_clause" nil :type (struct "indexclause") :id 3 :optional t)))
...
(thrift:def-struct "columndef"
  (("name" nil :type string :id 1)
   ("validation_class" nil :type string :id 2)
   ("index_type" nil :type (enum "IndexType") :id 3 :optional t)
   ("index_name" nil :type string :id 4 :optional t)))
...
(thrift:def-struct "cfdef"
  (("table" nil :type string :id 1)
   ...
   ("column_metadata" nil :type (thrift:list (struct "columndef")) :id 13 :optional t)))
