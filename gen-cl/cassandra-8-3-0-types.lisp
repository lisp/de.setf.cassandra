...
(thrift:def-package :cassandra_8.3.0)
...
"
  (("name" nil :id 1 :type binary)
   ...
   ("clock" nil :id 3 :type (struct "clock"))
   ("ttl" nil :id 4 :type i32 :optional t)))
...
"
  (("column_family" nil :id 3 :type string)
...
"
  (("start" nil :id 1 :type binary)
   ...
   ("bitmasks" nil :id 5 :type (thrift:list string) :optional t)))
...
"
  (("column_names" nil :id 1 :type (thrift:list string) :optional t)
   ("slice_range" nil :id 2 :type (struct "slicerange") :optional t)))

(thrift:def-struct "indexexpression"
  (("column_name" nil :id 1 :type binary)
   ("op" nil :id 2 :type (enum "IndexOperator"))
   ("value" nil :id 3 :type binary)))

(thrift:def-struct "indexclause"
  (("expressions" nil :id 1 :type (thrift:list (struct "indexexpression")))
   ("count" 100 :id 2 :type i32)
   ("start_key" nil :id 3 :type binary :optional t)))
...
(thrift:def-struct "rowpredicate"
  (("keys" nil :id 1 :type (thrift:list string) :optional t)
   ("key_range" nil :id 2 :type (struct "keyrange") :optional t)
   ("index_clause" nil :id 3 :type (struct "indexclause") :optional t)))
...
(thrift:def-struct "keycount"
  (("key" nil :id 1 :type binary)
   ("count" nil :id 2 :type i32)))

(thrift:def-struct "deletion"
  (("clock" nil :id 1 :type (struct "clock"))
...
(thrift:def-struct "tokenrange"
  (("start_token" nil :id 1 :type string)
   ...
   ("endpoints" nil :id 3 :type (thrift:list string))))
...
(thrift:def-struct "columndef"
  (("name" nil :id 1 :type binary)
   ("validation_class" nil :id 2 :type string)
   ("index_type" nil :id 3 :type (enum "IndexType") :optional t)
   ("index_name" nil :id 4 :type string :optional t)))

(thrift:def-struct "cfdef"
  (("table" nil :id 1 :type string)
   ("name" nil :id 2 :type string)
   ("column_type" "Standard" :id 3 :type string :optional t)
   ("clock_type" "Timestamp" :id 4 :type string :optional t)
   ("comparator_type" "BytesType" :id 5 :type string :optional t)
   ("subcomparator_type" "" :id 6 :type string :optional t)
   ("reconciler" "" :id 7 :type string :optional t)
   ("comment" "" :id 8 :type string :optional t)
   ("row_cache_size" 0 :id 9 :type double :optional t)
   ("preload_row_cache" nil :id 10 :type bool :optional t)
   ("key_cache_size" 200000 :id 11 :type double :optional t)
   ("read_repair_chance" 1 :id 12 :type double :optional t)
   ("column_metadata" nil :id 13 :type (thrift:list (struct "columndef")) :optional t)))

(thrift:def-struct "ksdef"
  (("name" nil :id 1 :type string)
   ("strategy_class" nil :id 2 :type string)
   ("replication_factor" nil :id 3 :type i32)
   ("cf_defs" nil :id 5 :type (thrift:list (struct "cfdef")))))
...
@Deprecated; use `scan`
")
  (:method "scan" ((("column_parent" (struct "columnparent") 1) ("row_predicate" (struct "rowpredicate") 2) ("column_predicate" (struct "slicepredicate") 3) ("consistency_level" (enum "ConsistencyLevel") 4)) (thrift:list (struct "keyslice")))
   :exceptions (("ire" nil :id 1 :type (struct "invalidrequestexception"))
   ("ue" nil :id 2 :type (struct "unavailableexception"))
   ("te" nil :id 3 :type (struct "timedoutexception")))
   :documentation "Returns the subset of columns specified in SlicePredicate for the rows requested in RowsPredicate
")
  (:method "scan_count" ((("column_parent" (struct "columnparent") 1) ("row_predicate" (struct "rowpredicate") 2) ("column_predicate" (struct "slicepredicate") 3) ("consistency_level" (enum "ConsistencyLevel") 4)) (thrift:list (struct "keycount")))
   :exceptions (("ire" nil :id 1 :type (struct "invalidrequestexception"))
   ("ue" nil :id 2 :type (struct "unavailableexception"))
   ("te" nil :id 3 :type (struct "timedoutexception")))
   :documentation "Counts the subset of columns specified in SlicePredicate for the rows requested in RowsPredicate
")
